...
const Home = () => {
  ...
  return (
    ...
    <Box backgroundImage={`url(${myBackgroundImage})`} backgroundSize={"cover"} backgroundPosition={"center"} backgroundRepeat={"no-repeat"}  >
      <Container maxWidth={"6xl"}>
        ...
        <Link to={"https://www.linkedin.com/in/demiladeleshi276/"}><FaLinkedin /></Link>
        </Flex>
        </Flex>
      </Container>
    </Box>
